...
NEW_IMAGE_TAG="dev-$(cat /home/playground/myagent/_work/12/a/image-tag/imageTag.txt)"

# Specify the path to your Kubernetes deployment YAML file
DEPLOYMENT_FILE="/home/playground/myagent/_work/12/s/deployments/deployment-dev.yml"
